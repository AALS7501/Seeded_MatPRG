...
|---|---|---|---|---|---|---|
| 6 | 64 KB | 2048 | 683 | 811 | 3 | 10 |
| 7 | 128 KB | 4096 | 683 | 811 | 6 | 20 |
| 8 | 256 KB | 9182 | 766 | 894 | 12 | 42 |
| 9 | 512 KB | 16000 | 762 | 890 | 21 | 74 |
| 10 | 1 MB | 32000 | 762 | 890 | 42 | 147 |
| 11 | 2 MB | 62000 | 766 | 894 | 81 | 283 |
| 12 | 4 MB | 124000 | 766 | 894 | 162 | 566 |
...
For this circuit, `M1` is the witnessed seed length in bits, `M2 × K` is the size of the expanded binary key matrix used by the outer MatPRG step, and `N1 × Low_bits` is the number of bits produced by the truncation step before parsing. In the paper-facing presets for `DATA_LOG=6..12`, we use an attack-aware generic calibration for the binary-input instances. For the original baseline and the seeded outer step, we compare the search exponent `m/2 - log2 l` against the binary-image membership exponent `m - n`; for the seeded inner expansion, we compare `m1/2` against `m1 - n1`. Each reported instance is selected so that the relevant exponent stays at or above 128 under the practical dense-matrix cap used by the artifact. This is a generic classical calibration for the instances used in the proofs, not a full lattice-hardness estimate.
...
| 6 | 64 KB | 2048 | 683 | 256 | 811 | 3 | 20 | 123 |
| 7 | 128 KB | 4096 | 683 | 256 | 811 | 6 | 40 | 123 |
| 8 | 256 KB | 9182 | 766 | 260 | 894 | 12 | 88 | 123 |
| 9 | 512 KB | 16000 | 762 | 280 | 890 | 21 | 152 | 123 |
| 10 | 1 MB | 32000 | 762 | 443 | 890 | 42 | 315 | 119 |
| 11 | 2 MB | 62000 | 766 | 742 | 894 | 81 | 614 | 118 |
| 12 | 4 MB | 124000 | 766 | 1356 | 894 | 162 | 1228 | 118 |

...
impl<E: Pairing, QAP: R1CSToQAP> SNARK<E::ScalarField> for CPGroth16<E, QAP> {
    ...
    fn circuit_specific_setup<C: ConstraintSynthesizer<E::ScalarField>, R: RngCore>(
        ...
        let pk = Self::generate_random_parameters_with_committed(circuit, 0, rng)?;
        let vk = pk.vk.clone();
        Ok((pk, vk))
    }
...
impl<E: Pairing, QAP: R1CSToQAP> CircuitSpecificSetupSNARK<E::ScalarField> for CPGroth16<E, QAP> {}

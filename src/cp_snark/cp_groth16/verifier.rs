...
use crate::cp_snark::cp_groth16::{r1cs_to_qap::R1CSToQAP, CPGroth16};
...
impl<E: Pairing, QAP: R1CSToQAP> CPGroth16<E, QAP> {
    pub fn prepare_inputs(
        ...
        if (public_inputs.len() + 1 + pvk.vk.committed_size as usize) != pvk.vk.gamma_abc_g1.len() {
    ...
    pub fn verify_proof_with_prepared_inputs(
        ...
        let verifier_time = start_timer!(|| "CPGroth16::Verifier");
    ...
    pub fn verify_proof(
        ...
        let verifier_time = start_timer!(|| "CPGroth16::Verifier");
        let prepare_input_time = start_timer!(|| "Prepare inputs");
        let prepared_inputs = Self::prepare_inputs(pvk, public_inputs)?;
        end_timer!(prepare_input_time);

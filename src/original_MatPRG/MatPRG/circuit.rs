...
pub struct MatPRGCircuit<C: CurveGroup, GG: CurveVar<C, ConstraintF<C>>>
where
...
#[allow(non_snake_case)]
impl<C, GG> ConstraintSynthesizer<C::BaseField> for MatPRGCircuit<C, GG>
where
    C: CurveGroup,
...
#[allow(non_snake_case)]
impl<C, GG> MockingCircuit<C, GG> for MatPRGCircuit<C, GG>
where
    C: CurveGroup,
    GG: CurveVar<C, C::BaseField>,
    <C as CurveGroup>::BaseField: PrimeField + Absorb,
    for<'a> &'a GG: GroupOpsBounds<'a, C, GG>,
{
    ...
    type Output = MatPRGCircuit<C, GG>;
